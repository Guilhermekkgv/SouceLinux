...
local Linux = {
    Theme = {
        ...
        SelectedOption = Color3.fromRGB(135, 206, 250)
    }
}
...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            ...
            TabSeperator.Position = UDim2.new(0, 0, 0.1, 0)

            TweenService:Create(TabSeperator, tweenInfo, {Position = UDim2.new(0, 0, 0.9, 0)}):Play()
            task.wait(0.15)
            TweenService:Create(TabSeperator, tweenInfo, {Position = UDim2.new(0, 0, 0.1, 0)}):Play()
