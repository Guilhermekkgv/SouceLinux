    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Slider(config)
            ...
            local ValueLabel = Linux.Instance("TextLabel", {
                ...
                Position = UDim2.new(0, SliderBar.Position.X.Offset - 5, 0.5, -7),
                Font = Enum.Font.SourceSans,
            ...
            ValueLabel.Position = UDim2.new(0, SliderBar.Position.X.Offset - ValueLabel.Size.X.Offset - 5, 0.5, -ValueLabel.Size.Y.Offset / 2)
