            ...
            local function PopulateOptions()
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        ...
                        -- Adicionando a barrinha (OptionSeperator) antes do texto
                        local OptionSeperator = Linux.Instance("Frame", {
                            Name = "OptionSeperator",
                            Parent = OptBtn,
                            BackgroundColor3 = Linux.Theme.Accent,
                            Size = UDim2.new(0, 4, 0.8, 0),
                        ...
                        Linux.Instance("UICorner", {
                            Parent = OptionSeperator,
                            CornerRadius = UDim.new(0, 6)
                        })

                        -- Ajustando o texto para ficar à direita da barrinha
                        OptBtn.TextXAlignment = Enum.TextXAlignment.Left
                        Linux.Instance("UIPadding", {
                            Parent = OptBtn,
                            PaddingLeft = UDim.new(0, 15) -- Espaço para a barrinha (5 + 4 + 6 de margem)
                        })
