...
local Linux = {
    Theme = {
        ...
        Element = Color3.fromRGB(31, 31, 43),
        Accent = Color3.fromRGB(255, 6, 4),
        Text = Color3.fromRGB(255, 255, 255),
        Toggle = Color3.fromRGB(40, 41, 52),
        TabInactive = Color3.fromRGB(31, 31, 43),
        DropdownOption = Color3.fromRGB(40, 41, 52)
    }
}
...
function Linux.Create(config)
    ...
    local TopBar = Linux.Instance("Frame", {
        Parent = Main,
        BackgroundColor3 = Color3.fromRGB(40, 41, 52),
        Size = UDim2.new(1, 0, 0, 22),
        ZIndex = 2,
        BorderSizePixel = 0
    })

    local HeadingSeperator = Linux.Instance("Frame", {
        Parent = TopBar,
        Name = "HeadingSeperator",
        AnchorPoint = Vector2.new(0, 1),
        BackgroundColor3 = Color3.fromRGB(163, 33, 38),
        BorderSizePixel = 0,
    ...
    local TabsBar = Linux.Instance("Frame", {
        ...
        Size = UDim2.new(0, tabWidth, 1, -22),
        ZIndex = 2,
        BorderSizePixel = 0
    })
    ...
    local Content = Linux.Instance("Frame", {
        Parent = Main,
        BackgroundTransparency = 1,
        Position = UDim2.new(0, tabWidth, 0, 22),
        Size = UDim2.new(1, -tabWidth, 1, -22),
        ZIndex = 1,
        BorderSizePixel = 0
    })
    ...
    MinimizeButton.MouseButton1Click:Connect(function()
        ...
        if not isMinimized then
            TweenService:Create(Main, tweenInfo, {Size = UDim2.new(0, 200, 0, 22), Position = UDim2.new(0.5, -100, 0, 0)}):Play()
    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            for _, tab in pairs(Tabs) do
                ...
                tab.Button.BackgroundColor3 = Linux.Theme.TabInactive
                tab.Text.TextColor3 = Linux.Theme.Text
        ...
        function TabElements.Toggle(config)
            ...
            local function UpdateToggle()
                ...
                if State then
                    ...
                    TweenService:Create(Knob, tween, {Position = UDim2.new(1, -20, 0, 0), BackgroundColor3 = Linux.Theme.Text}):Play()
                else
                    TweenService:Create(ToggleFill, tween, {BackgroundColor3 = Linux.Theme.Toggle, Size = UDim2.new(0, 0, 1, 0)}):Play()
                    TweenService:Create(Knob, tween, {Position = UDim2.new(0, 0, 0, 0), BackgroundColor3 = Color3.fromRGB(150, 150, 150)}):Play()
                end
            end
        ...
        function TabElements.Section(config)
            ...
            local Heading = Linux.Instance("Frame", {
                Parent = Section,
                BackgroundColor3 = Color3.fromRGB(40, 41, 52),
                BorderSizePixel = 0,
                Size = UDim2.new(1, 0, 0, 22),
