...
local Linux = {
    Theme = {
        ...
        DropdownOption = Color3.fromRGB(25, 25, 25), -- Escurecido
...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        local function AnimateTabTransition()
            local tweenInfo = TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
            TweenService:Create(ElementContainer, tweenInfo, {Position = UDim2.new(1, 0, 0, 30)}):Play()
            task.wait(0.15)
            TweenService:Create(ElementContainer, tweenInfo, {Position = UDim2.new(0, 0, 0, 30)}):Play()
        end
        ...
        function TabElements.Toggle(config)
            ...
            local function UpdateToggle()
                ...
                if State then
                    ...
                    TweenService:Create(ToggleFill, tween, {Size = UDim2.new(0, 0, 1, 0)}):Play()
        ...
        function TabElements.Dropdown(config)
            ...
            local DropFrame = Linux.Instance("ScrollingFrame", {
                Parent = ElementContainer,
                BackgroundColor3 = Color3.fromRGB(20, 20, 20), -- Escurecido
                BorderColor3 = Color3.fromRGB(50, 50, 50),
                BorderSizePixel = 1,
        ...
        function TabElements.Slider(config)
            ...
            local ValueLabel = Linux.Instance("TextLabel", {
                ...
                Font = Enum.Font.Gotham,
                Text = tostring(config.Default or config.Min or 0), -- Corrigido para exibir Default inicialmente
                TextColor3 = Color3.fromRGB(255, 255, 255),
                TextSize = 14,
                TextXAlignment = Enum.TextXAlignment.Right,
                TextYAlignment = Enum.TextYAlignment.Center,
            ...
            -- Inicializar o slider com o valor Default
            SetValue(Default)
        ...
        function TabElements.Paragraph(config)
            ...
            Linux.Instance("TextLabel", {
                ...
                TextColor3 = Color3.fromRGB(255, 255, 255), -- Corrigido para branco puro
                TextSize = 16,
                TextXAlignment = Enum.TextXAlignment.Left,
                ZIndex = 1
            })
